...
export const commands: Chat.ChatCommands = {
	...
	tcghelp: [
		...
		'/tcg rankedbattle challenge, [user] - Challenge a player with detailed turn-by-turn battle simulation',
		'/tcg rankedbattle preview, [user] - Preview ELO stakes and matchup info before challenging',
		'/tcg rankedbattle targets - View available players you can challenge',
		'/tcg rankedbattle status - Check your daily challenge status',
